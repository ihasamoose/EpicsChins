...
public class Tiles {
	public final static Tile[] PATH_TO_PRAYER_FROM_GE = {new Tile(3185, 3492, 0), new Tile(3197, 3480, 0), new Tile(3196, 3462, 0), new Tile(3216, 3464, 0), new Tile(3233, 3466, 0), new Tile(3245, 3480, 0)};
	public final static Tile[] PATH_TO_PRAYER_FROM_TELE = {new Tile(3216, 3464, 0), new Tile(3233, 3466, 0), new Tile(3245, 3480, 0)};
	public final static Tile[] PATH_TO_CHIN_TILE_1 = {new Tile(2770, 9120, 0), new Tile(2758, 9133, 0), new Tile(2740, 9137, 0), new Tile(2722, 9140, 0), new Tile(2714, 9138, 0)};
	public final static Tile[] PATH_TO_CHIN_TILE_2 = {new Tile(2731, 9130, 0), new Tile(2744, 9125, 0)};
	public final static Tile[] PATH_TO_CHIN_TILE_3 = {new Tile(2743, 9120, 0), new Tile(2738, 9120, 0), new Tile(2737, 9121, 0), new Tile(2720, 9118, 0)};
	public final static Tile[] PATH_TO_BANK_TILE = {new Tile(3205, 3440, 0), new Tile(3191, 3451, 0), new Tile(3175, 3459, 0)};
	...
	public final static java.util.List<Tile> CHIN_LIST = Arrays.asList(Tiles.TILE_CHIN_1, Tiles.TILE_CHIN_2, Tiles.TILE_CHIN_3, Tiles.TILE_CHIN_4);
